...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "content", sa.Text(), nullable=True, comment="消息文本内容；工具调用消息可存null"
        ),
        sa.Column(
            "token_count",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.Column(
            "user_id", sa.String(length=64), nullable=False, comment="所属用户ID，关联users表主键id"
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.Column(
            "username", sa.String(length=128), nullable=False, comment="登录用户名，全局唯一"
        ),
        sa.Column(
            "email", sa.String(length=255), nullable=False, comment="用户邮箱，用于登录、找回密码"
        ),
        sa.Column(
            "hashed_password",
        ...
        sa.Column(
            "is_active", sa.Boolean(), nullable=False, comment="账号是否启用，false代表禁用账号"
        ),
        sa.Column(
            "is_superuser", sa.Boolean(), nullable=False, comment="是否超级管理员，拥有全部后台权限"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
