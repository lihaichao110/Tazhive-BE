...
down_revision: Union[str, Sequence[str], None] = '5572b565941c'
...
def upgrade() -> None:
    ...
    sa.Column('chunk_index', sa.Integer(), nullable=False, comment='分片序号，标记当前文档内第几个切片'),
    sa.Column('content', sa.Text(), nullable=False, comment='文本分片原始内容'),
    sa.Column('embedding', pgvector.sqlalchemy.vector.VECTOR(dim=1536), nullable=True, comment='文本向量Embedding，1536维浮点数数组'),
    sa.Column('meta_data', sa.JSON(), nullable=True, comment='自定义扩展元数据，存储附加业务信息'),
