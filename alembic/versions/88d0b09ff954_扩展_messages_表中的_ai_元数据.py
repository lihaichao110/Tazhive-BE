...
down_revision: str | Sequence[str] | None = "23347f72c50a"
...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=True,
            comment="模型思维链思考内容，DeepSeek等模型输出的内部思考文本",
        ),
    )
    op.add_column(
        "messages",
        sa.Column(
            ...
            sa.JSON(),
            nullable=True,
            comment="response_metadata内token_usage，token消耗明细字典",
        ),
    )
    op.add_column(
        "messages",
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            nullable=True,
            comment="模型名称，例如 deepseek‑v4‑flash，冗余快捷字段",
        ),
    )
    op.add_column(
        "messages",
        sa.Column(
            ...
            sa.String(length=50),
            nullable=True,
            comment="会话结束原因：stop / length / tool_calls",
        ),
    )
    op.add_column(
        "messages",
        sa.Column(
            "message_id", sa.String(length=100), nullable=True, comment="大模型返回的消息唯一id"
        ),
    )
    op.alter_column(
        "messages",
